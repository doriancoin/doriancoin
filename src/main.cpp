...
int64 nChainStartTime = 1394489999;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Liberty is generally considered a concept of political philosophy that seeks to identify";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("f6bb442dfd105e81767f963a9cac545c81ed2fac793724347945bc521dd2d143"));
